...
export const LEAD_PROMPTS: Record<LeadField, string> = {
  ...
  whoToFind: "2/5. Кого ищем?\nТочно: отрасль + специализация + признаки компании.\nПример: частные стоматологические клиники с имплантацией и ортодонтией.",
  whereToSearch: "3/5. Где искать?\nУкажите страну, город/область и при необходимости каталоги или домены.\nПример: Россия, Москва и Московская область. Чем точнее география, тем меньше похожих результатов.",
