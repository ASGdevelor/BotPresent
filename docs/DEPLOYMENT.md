...
Процесс должен иметь право записи в `./data`: там сохраняются история и созданные презентации. Резервное копирование и удаление данных выполняются владельцем сервера согласно его политике.
